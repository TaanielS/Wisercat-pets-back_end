package com.saarnik.pet.pet_management.config;
...
import com.saarnik.pet.pet_management.jwt.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/api/pets", "/api/option", "/api/authenticate",
                                "/api/login")
                        .permitAll()
